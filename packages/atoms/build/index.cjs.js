...
var theme = _interopDefault(require('@design-system/theme'));
var React$3 = require('react');
var React$3__default = _interopDefault(React$3);
var reactDom = _interopDefault(require('react-dom'));
var ReactTinyPopover = require('react-tiny-popover');
var ReactTinyPopover__default = _interopDefault(ReactTinyPopover);
var RSelect = require('react-select');
var RSelect__default = _interopDefault(RSelect);
var AsyncRSelect = _interopDefault(require('react-select/lib/Async'));
...
var Box = styled__default('div')({
  ...
  position: 'relative'
}, styledSystem.space, styledSystem.color, styledSystem.width, styledSystem.height, styledSystem.fontSize, styledSystem.flex, styledSystem.order, styledSystem.alignSelf, styledSystem.minWidth, styledSystem.maxWidth, function (props) {
  return props.css;
});
Box.displayName = 'Box';
Box.propTypes = {
...
var Flex = styled__default(Box)(_templateObject(), styledSystem.alignItems, styledSystem.justifyContent, styledSystem.flexWrap, styledSystem.flexDirection);
Flex.propTypes = {
...
var Card = styled__default(Box)(_templateObject$1(), boxShadow, boxBorder, styledSystem.borderRadius);
Card.propTypes = {
  /** Размер тени */
...
var Relative = styled__default(Box)(_templateObject$2(), styledSystem.top, styledSystem.right, styledSystem.bottom, styledSystem.left, styledSystem.zIndex);
Relative.propTypes = {
  /** Смещение сверху */
...
var Absolute = styled__default(Box)(_templateObject$3(), styledSystem.top, styledSystem.right, styledSystem.bottom, styledSystem.left, styledSystem.zIndex);
Absolute.propTypes = {
  /** Смещение сверху */
  top: PropTypes.oneOfType([PropTypes.number, PropTypes.string, PropTypes.array]),
...
var StyledFlex = styled__default(Flex)(_templateObject$4(), getColor);
...
var Text = styled__default.div(_templateObject$5(), function (props) {
  return props.theme.colors.text;
}, italic, styledSystem.fontSize, styledSystem.space, truncated, styledSystem.color, caps, regular, bold, align, inline, strike); // Text.span = Text.withComponent('span')
...
var Button = styled__default.button(_templateObject$6(), function (props) {
...
}, block, styledSystem.space, size, type, shapeCircle);
Button.propTypes = {
  /** Вид кнопки */
...
var DividerComponent = styled__default.div(_templateObject$7(), function (props) {
  return props.theme.colors[props.color];
}, function (props) {
  return props.theme.colors[props.color];
}, styledSystem.space, vertical);
...
var rotate = styled.keyframes(["from{transform:rotate(360deg);}to{transform:rotate(0deg);}"]);
var spinanimation = styled.css(["animation:", " 2s linear infinite;"], rotate);
var IconBordered = styled__default(Flex)(_templateObject$8(), function (props) {
...
var disabled = function disabled(props) {
  return props.disabled && styled.css(["opacity:0.4;cursor:not-allowed;"]);
};

var PanelContent = styled__default(Box)(_templateObject$9(), function (props) {
  return "transition: height ".concat(props.theme.duration.normal, ";");
}); // To fix warning because of passing isOpen prop to <svg />

var AnimatedScaledIcon = styled__default(Relative)(_templateObject2(), themeGet('color.black', '#080808'), themeGet('duration.normal', '300ms'), function (props) {
  return props.isOpen && "transform: rotate(180deg);";
});
var PanelHeaderWrapper = styled__default(Flex)(_templateObject3(), function (props) {
  return props.titleAlignment;
}, themeGet('colors.border', '#ecebeb'), function (props) {
  return props.disabled ? 'cursor: not-allowed;' : 'cursor: pointer;';
});
var PanelWrapper = styled__default(Flex)(_templateObject4(), function (props) {
...
var CheckboxInput = styled__default.input.attrs({
  type: 'checkbox'
})(_templateObject$a());
var StyledCheckbox = styled__default(Flex)(_templateObject2$1(), themeGet('radii[0]', 4), themeGet('duration.fast', 300), size$1, background, border, CheckboxInput, function (props) {
  return props.theme.colors.blue;
});
var Label = styled__default.label(_templateObject3$1(), function (props) {
  return props.disabled ? 'not-allowed' : 'pointer';
}, styledSystem.space);
var CheckboxContainer = styled__default(Flex)(_templateObject4$1());
...
var withRequiredAsterisk = function withRequiredAsterisk(props) {
  return props.required && styled.css(["& > ", ":after{content:' *';display:inline-block;margin-right:", "px;margin-left:", "px;line-height:1;color:", ";font-size:", "px;}"], Label$1, props.theme.space[1], props.theme.space[1], props.theme.colors.error, props.theme.fontSizes[2]);
};

var hasError = function hasError(props) {
  return props.help && styled.css(["margin-bottom:", "px;& input{border-color:", ";background:", ";}", "{border-color:", ";}"], props.theme.space[2], props.theme.colors.error, props.theme.colors.white, StyledCheckbox, props.theme.colors.error);
};

var LabelWrapper = styled__default(Box)(_templateObject$b(), function (props) {
  return props.inline ? '20%' : '100%';
}, function (props) {
  return props.theme.fontSizes[1];
}, withRequiredAsterisk);
var ControlWrapper = styled__default(Box)(_templateObject2$2(), function (props) {
  return props.theme.space[2];
}, hasError);
var HelpWrapper = styled__default(Box)(_templateObject3$2(), function (props) {
...
var HTMLInput = styled__default.input(_templateObject$c(), themeGet('font.main', "'PT Sans'"), function (props) {
  return props.theme.radii[1] + 'px';
}, function (props) {
  return props.theme.duration.fast;
...
}, styledSystem.width, styledSystem.space, size$2, disabled$1, inline$1);
var InputWrapper = styled__default(Relative)({
  display: 'flex',
  flexGrow: 1,
  alignItems: 'center'
});
var Adornment = styled__default(Absolute)({
  display: 'flex'
});
...
var HTMLTextarea = styled__default.textarea(_templateObject$d(), themeGet('font.main', "'PT Sans'"), function (props) {
  return props.theme.fontSizes[1];
}, function (props) {
  return props.theme.radii[1] + 'px';
}, function (props) {
  ...
  return props.theme.colors.lightGrey;
}, styledSystem.fontSize, styledSystem.width, styledSystem.space, disabled$2);
var InputWrapper$1 = styled__default(Relative)({
  display: 'flex',
  flexGrow: 1,
  alignItems: 'center'
});
...
var tracksBackground = function tracksBackground(props) {
  ...
  if (disabled) {
    return styled.css(["background:", ";"], themeGet('colors.grey', '#b5b5b5'));
  }

  if (checked) {
    return styled.css(["background:", ";"], themeGet('colors.lightBlue', '#0091ea'));
  }

  return styled.css(["background:", ";"], themeGet('colors.white', '#ffffff'));
};
...
var tracksBorder = function tracksBorder(_ref) {
  ...
  if (!checked && !disabled) {
    return styled.css(["border-color:", ";"], themeGet('colors.black', '#3a3a3a'));
  }
...
var handleBackground = function handleBackground(_ref2) {
  ...
  return styled.css(["background:", ";"], disabled ? themeGet('colors.lightGrey', '#f5f5f5') : themeGet('color.white', '#ffffff'));
};
...
var handlePosition = function handlePosition(_ref4) {
  ...
  if (checked) {
    return styled.css(["top:2px;left:10px;"]);
  }

  return styled.css(["top:2px;left:2px;"]);
};
...
var ToggleHandle = styled__default(Absolute)(_templateObject$e(), handleBackground, handlePosition, handleBorder, themeGet('durations.normal', '300ms'));
var ToggleTrack = styled__default.button.attrs({
  role: 'switch'
...
var TabPane = styled__default(Box)(_templateObject$f(), function (props) {
...
var borderBottom = function borderBottom(props) {
  return styled.css(["", ":hover{", "}"], props.isActive && "border-bottom: 1px solid ".concat(props.theme.colors.tabs.active), !props.disabled && !props.isActive && "border-bottom: 1px solid ".concat(props.theme.colors.tabs.hover));
};

var isDisabled = function isDisabled(props) {
  return props.disabled && styled.css(["cursor:not-allowed;opacity:0.4;"]);
};

var TabsList = styled__default(Flex)(_templateObject$g(), function (props) {
  return props.theme.fontSizes[1] + 'px';
});
var Tab = styled__default(Flex)(_templateObject2$4(), function (props) {
  return props.theme.fontSizes[1] + 'px';
...
var RadioInput = styled__default.input.attrs({
  type: 'radio'
})(_templateObject$h());
var StyledRadio = styled__default(Flex)(_templateObject2$5(), themeGet('duration.fast', 300), size$3, background$1, border$1);
var Label$2 = styled__default.label(_templateObject3$3(), function (props) {
  return props.disabled ? 'not-allowed' : 'pointer';
}, styledSystem.space);
var RadioContainer = styled__default(Flex)(_templateObject4$2());
...
function Popover(props) {
  return React$3__default.createElement(ReactTinyPopover__default, props);
}
...
function createListComponent(_ref) {
  ...
  function (_PureComponent) {
    ...
    _proto.render = function render() {
      ...
      if (itemCount > 0) {
        for (var _index = startIndex; _index <= stopIndex; _index++) {
          items.push(React$3.createElement(children, {
            data: itemData,
      ...
      return React$3.createElement(outerElementType || outerTagName || 'div', {
        className: className,
        onScroll: onScroll,
      ...
      }, React$3.createElement(innerElementType || innerTagName || 'div', {
        children: items,
        ref: innerRef,
        style: {
    ...
    return List;
  }(React$3.PureComponent), _class.defaultProps = {
    direction: 'ltr',
    itemData: undefined,
    layout: 'vertical',
    overscanCount: 2,
...
var DropdownIndicator = function DropdownIndicator(props) {
  ...
  return React$3.createElement(RSelect.components.DropdownIndicator, _extends({}, rest, {
    innerProps: withPadding
  }), React$3.createElement(Icon, {
...
var scrollStyles = function scrollStyles(_ref) {
  var theme = _ref.theme;
  return styled.css(["&::-webkit-scrollbar{height:8px;background-color:transparent;width:4px;}&::-webkit-scrollbar-thumb{background-color:", ";border-radius:10px;}scrollbar-color:", " transparent;scrollbar-width:thin;"], theme.colors.scrollbar, theme.colors.scrollbar);
};

var StyledList = styled__default(FixedSizeList)(_templateObject$i(), scrollStyles);
  ...
  return (
    ...
    function (_React$Component) {
      ...
      function MenuList() {
        ...
        _defineProperty(_assertThisInitialized(_this), "list", React$3.createRef());
      ...
      _createClass(MenuList, [{
        ...
        value: function render() {
          ...
          if (!children.length) {
            /* No option message */
            return React$3.createElement(Box, null, children, "1");
          }

          return React$3.createElement(StyledList, {
            ref: this.list,
            height: maxHeight,
    ...
    value: function render() {
      ...
      var selectProps = _objectSpread2({
        ...
        components: {
          ...
          MenuList: virtualized ? MenuList(optionHeight || OPTION_HEIGHT) : RSelect.components.MenuList
        }
      }, this.props);

      return React$3.createElement(styled.ThemeConsumer, null, function (systemTheme) {
        return async ? React$3.createElement(AsyncRSelect, _extends({}, selectProps, {
          systemTheme: systemTheme,
          theme: _this3.withSystemTheme(size, systemTheme)
        })) : React$3.createElement(RSelect__default, _extends({}, selectProps, {
          systemTheme: systemTheme,
          theme: _this3.withSystemTheme(size, systemTheme)
        }));
      });
...
var EnhancedScrollbars = styled__default(ReactCustomScrollbars)(_templateObject$j(), styledSystem.flex, styledSystem.order, styledSystem.alignSelf);
/**
...
var StyledHeader = styled__default(lib_1$1)(_templateObject2$6(), themeGet('colors.lightGrey', '#f5f5f5'), function (props) {
  return props.theme.fontSizes[1];
});
...
exports.Flex = Flex;
exports.FlexContainerBottomDivider = FlexContainerBottomDivider;
exports.Form = Form;
exports.Heading = Heading;
exports.Icon = Icon;
exports.Input = Input;
exports.Modal = Modal$2;
exports.NotificationsCounter = NotificationsCounter;
exports.Overlay = Overlay;
exports.Popover = Popover;
exports.Radio = Radio;
exports.RadioGroup = RadioGroup;
exports.Relative = Relative;
exports.ResizableInput = ResizableInput;
exports.Scrollbars = Scrollbars$2;
